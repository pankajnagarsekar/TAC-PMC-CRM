// PROJECT SELECTION SCREEN FOR ADMIN
// Admin must select a project before accessing other features
...
export default function AdminProjectSelectionScreen() {
  ...
  const loadProjects = async () => {
    try {
      ...
      // Admin sees ALL projects (no filtering by assigned_projects)
