// SHARED DPR FORM COMPONENT
// Reusable DPR creation UI for both Admin and Supervisor roles
        ...
        if (submitData.pdf_data) {
          try {
            if (Platform.OS === 'web') {
              ...
              showAlert(
                'Success',
                `DPR submitted and PDF downloaded!\n\nFilename: ${submitData.file_name}`,
                onSuccess
              );
            } else {
              try {
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerInfo}>
            ...
            <Text style={styles.headerSubtitle}>
              {projectCode || 'DPR'} • {getTodayFormatted()}
            </Text>
          </View>
        </View>
      )}
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        ...
        <Card style={styles.projectCard}>
          ...
          <View style={styles.projectInfo}>
            ...
            {projectCode && <Text style={styles.projectCode}>{projectCode}</Text>}
          </View>
        </Card>
        ...
        <Card style={styles.sectionCard}>
          ...
          />
          <Text style={styles.helperText}>Speak in any language - AI will translate to English</Text>
        </Card>
