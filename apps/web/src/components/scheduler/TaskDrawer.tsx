...
export default function TaskDrawer() {
  ...
  const [localTaskName, setLocalTaskName] = useState(selectedTask?.task_name || selectedTask?.task_description || "");
            ...
            <div className="mb-4 flex items-center justify-between gap-2">
              <div>
                <p className="text-sm font-semibold text-slate-900 dark:text-white">
                  {selectedTask.task_name || selectedTask.task_description || 'Unnamed Task'}
                </p>
