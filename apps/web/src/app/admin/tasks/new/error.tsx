...
export default function NewTaskError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[NewTask] Unhandled error:", error);
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[60vh] gap-6">
      ...
      <div className="text-center">
        <h2 className="text-xl font-bold text-white mb-2">Failed to Create Task</h2>
        <p className="text-slate-400 text-sm max-w-md">
          {error.message || "An unexpected error occurred. Please check your inputs and try again."}
        </p>
      </div>
