      ...
      >
        ...
        {fetchError ? (
          <View style={styles.emptyState}>
            ...
            <Text style={[styles.emptyTitle, { color: '#ef4444' }]}>Failed to load projects</Text>
                  ...
                  <View style={styles.expandedSection}>
                    ...
                    <View style={styles.actionRow}>
                      ...
                      >
                        ...
                        <Text style={styles.actionBtnText}>DPRs</Text>
                      </Pressable>
                      <Pressable
                      ...
                      >
                        ...
                        <Text style={styles.actionBtnText}>Funds</Text>
                      </Pressable>
                    </View>
                  </View>
                )}
