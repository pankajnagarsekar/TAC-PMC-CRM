...
from app.modules.project.infrastructure.repository import BudgetRepository, ScheduleRepository
...
class DashboardService:
    ...
    async def get_project_dashboard_stats(self, project_id: str, organisation_id: str) -> Dict[str, Any]:
        ...
        dpr_recent = await self.db.workers_daily_logs.count_documents({"project_id": project_id, "created_at": {"$gte": yesterday}})
