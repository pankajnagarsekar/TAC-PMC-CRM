...
@router.get("/payments/{project_id}", response_model=GenericResponse[Dict[str, Any]], tags=["Payments"])
...
@router.post("/payments/", response_model=GenericResponse[PaymentCertificate], status_code=status.HTTP_201_CREATED, tags=["Payments"])
...
@router.post("/payments/{pc_id}/close", response_model=GenericResponse[Dict[str, Any]], tags=["Payments"])
...
@router.get("/cash/allocations", response_model=GenericResponse[List[Any]], tags=["Cash Management"])
...
@router.post("/cash/allocations", response_model=GenericResponse[Any], tags=["Cash Management"])
...
@router.get("/cash/transactions", response_model=GenericResponse[Dict[str, Any]], tags=["Cash Management"])
...
@router.get("/settings/codes", response_model=GenericResponse[List[CodeMaster]], tags=["Settings"])
...
@router.post("/settings/codes", response_model=GenericResponse[dict], status_code=status.HTTP_201_CREATED, tags=["Settings"])
...
@router.get("/cash/balance/{project_id}", response_model=GenericResponse[Dict[str, Any]], tags=["Cash Management"])
...
@router.get("/cash/summary/{project_id}", response_model=GenericResponse[Dict[str, Any]], tags=["Cash Management"])
