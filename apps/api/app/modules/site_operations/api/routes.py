...
@router.post("/worker-logs/", response_model=GenericResponse[WorkersDailyLog], status_code=status.HTTP_201_CREATED, tags=["Site Operations"])
...
@router.put("/worker-logs/{log_id}", response_model=GenericResponse[WorkersDailyLog], tags=["Site Operations"])
...
@router.patch("/dprs/{dpr_id}/approve", response_model=GenericResponse[Any], tags=["Site Operations"])
...
@router.patch("/dprs/{dpr_id}/reject", response_model=GenericResponse[Any], tags=["Site Operations"])
...
@router.post("/dprs/{dpr_id}/images", response_model=GenericResponse[Any], status_code=status.HTTP_201_CREATED, tags=["Site Operations"])
...
@router.put("/dprs/{dpr_id}/images/{image_id}", response_model=GenericResponse[Any], tags=["Site Operations"])
...
@router.post("/dprs/{dpr_id}/submit", response_model=GenericResponse[Any], tags=["Site Operations"])
...
@router.get("/projects/{project_id}/attendance", response_model=GenericResponse[List[Any]], tags=["Site Operations"])
...
@router.get("/projects/{project_id}/voice-logs", response_model=GenericResponse[List[Any]], tags=["Site Operations"])
...
@router.get("/projects/{project_id}/site-overheads", response_model=GenericResponse[List[SiteOverhead]], tags=["Site Operations"])
...
@router.post("/site-overheads", response_model=GenericResponse[SiteOverhead], status_code=status.HTTP_201_CREATED, tags=["Site Operations"])
...
@router.put("/site-overheads/{entry_id}", response_model=GenericResponse[SiteOverhead], tags=["Site Operations"])
