...
from app.core.dependencies import get_authenticated_user, get_vendor_service, get_work_order_service, verify_nonce
...
@router.post("/vendors/", response_model=GenericResponse[Vendor], status_code=status.HTTP_201_CREATED, tags=["Vendors"])
...
@router.get("/vendors/{vendor_id}", response_model=GenericResponse[Vendor], tags=["Vendors"])
...
@router.put("/vendors/{vendor_id}", response_model=GenericResponse[Vendor], tags=["Vendors"])
...
@router.delete("/vendors/{vendor_id}", response_model=GenericResponse[dict], tags=["Vendors"])
...
@router.get("/vendors/{vendor_id}/ledger", response_model=GenericResponse[List[Dict[str, Any]]], tags=["Vendors"])
...
@router.get("/work-orders/", response_model=GenericResponse[Dict[str, Any]], tags=["Work Orders"])
...
@router.post("/work-orders/{project_id}", response_model=GenericResponse[WorkOrder], status_code=status.HTTP_201_CREATED, tags=["Work Orders"])
...
@router.patch("/work-orders/{wo_id}", response_model=GenericResponse[WorkOrder], tags=["Work Orders"])
