...
class SchedulerService:
    ...
    def run_scheduler_script(self, script_name: str, input_data: dict) -> dict:
        ...
        base_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))) # apps/api/app
    ...
    async def save_schedule(self, project_id: str, organisation_id: str, user_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        schedule_doc = {
    ...
    async def load_schedule(self, project_id: str, organisation_id: str) -> Dict[str, Any]:
