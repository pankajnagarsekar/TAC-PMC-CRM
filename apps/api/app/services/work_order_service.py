...
class WorkOrderService:
    """
    Sovereign Work Order Orchestrator (Point 1, 31, 81, 91).
    ...
    async def update_work_order(self, user: dict, wo_id: str, update_req: WorkOrderUpdate) -> Dict[str, Any]:
        """Fixed CR-14/24: Enforces Optimistic Locking using expected_version."""
        organisation_id = user["organisation_id"]
        ...
        async with UnitOfWork(self.db) as uow:
            ...
            update_dict = {
                ...
                "version": update_req.expected_version # Triggers optimistic locking in BaseRepository.update
            }
