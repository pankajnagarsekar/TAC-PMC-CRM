...
from app.repositories.financial_repo import PCRepository, SequenceRepository
...
class PaymentService:
    """
    Sovereign Payment Orchestrator (Point 8, 75, 81, 91).
    Enforces atomic transactions via UnitOfWork.
    """
    ...
    async def create_payment_certificate(self, user: dict, pc_data: PaymentCertificateCreate) -> Dict[str, Any]:
        ...
        # Fixed CR-15: Using Sovereign UnitOfWork for atomic creation
        async with UnitOfWork(self.db) as uow:
            ...
            # 4. Financial Calculations (Authoritative Engine)
    ...
    async def close_payment_certificate(self, user: dict, pc_id: str) -> Dict[str, Any]:
        ...
        # Fixed CR-15: Atomic closing and cascading financial updates
        async with UnitOfWork(self.db) as uow:
            ...
            if pc_type == "PETTY_OVH":
                ...
                if fund_alloc:
                    ...
                    # RECONCILIATION: Immediate master budget update
