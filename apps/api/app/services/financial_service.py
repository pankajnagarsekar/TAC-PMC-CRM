...
class FinancialService:
    """
    Sovereign Logic Orchestrator for Financial Domain (Point 1, 61, 85, 125).
    ...
    async def recalculate_project_code_financials(self, project_id: str, category_id: str, session=None):
        """Standard recurrence pattern for project-category financial health (Point 61)"""
        ...
        # Use Engine for derived math (Point 61, 85)
        ...
        serializable_doc = {
            ...
            "logic_version": FinancialEngine.DOMAIN_LOGIC_VERSION, # Point 85
    ...
    async def recalculate_master_budget(self, project_id: str, session=None):
        """Aggregates all project categories into a single Master Snapshot (Point 61)"""
    ...
    async def check_threshold_breach(self, project_id: str, category_id: str, session=None) -> bool:
        """System Gate: Prevent unauthorized spending on depleted funds (Point 104)"""
