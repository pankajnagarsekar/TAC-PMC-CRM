    ...
    try:
        ...
        await db.work_orders.insert_many([
            ...
            },
            {
                ...
                "retention_amount": 0,
                "total_payable": 17228,
                "actual_payable": 17228,
                "line_items": [
                    {"sr_no": 1, "description": "Professional fees — Phase 1", "qty": 1, "rate": 14600, "total": 14600}
                ],
                "status": "Completed",
                "version": 1,
                "created_at": datetime.now(timezone.utc),
        ...
        await db.payment_certificates.insert_many([
            ...
            },
            {
                ...
                "vendor_name": "Rajesh Construction",
                "work_order_id": str(wo_civ_id),
                "work_order_ref": "TAC_WO_25_002",
                "subtotal": 535000,
                "discount": 0,
