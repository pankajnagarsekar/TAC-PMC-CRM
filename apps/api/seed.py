...
async def seed():
    ...
    if existing_settings:
        print("Global Settings - skipped (already exists)")
    else:
        settings_doc = {
            "organisation_id": org_id,
            "cgst_percentage": "9.0", # Decimals handled as strings/Decimal128 in BSON
            "sgst_percentage": "9.0",
        ...
        settings_doc["cgst_percentage"] = Decimal128("9.0")
        settings_doc["sgst_percentage"] = Decimal128("9.0")
        settings_doc["retention_percentage"] = Decimal128("5.0")
        
        await db.global_settings.insert_one(settings_doc)
        print("Global Settings - inserted")
